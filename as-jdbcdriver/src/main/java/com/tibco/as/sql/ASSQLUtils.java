...
public class ASSQLUtils
{
    ...
    public static Browser getBrowser (Space space, String whereClause, BrowserType browserType) throws ASException
    {
        return (whereClause == null) ? space.browse(browserType, BrowserDef.create(0, TimeScope.SNAPSHOT))
                : space.browse(browserType, BrowserDef.create(0, TimeScope.SNAPSHOT), whereClause.toString());
    }
